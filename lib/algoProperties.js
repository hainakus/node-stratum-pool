...
var algos = module.exports = global.algos = {
    ...
    hmq1725: {
        multiplier: Math.pow(2, 16),
        diff: '00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff',
        hash: function(){
            return function(){
    ...
    gltkeccak: {
        ...
        hash: function(){
            return function(){
                return multiHashing.gltkeccak.apply(this, arguments);
            }
        }
    },
    xevan: {
    ...
    padihash: {
        multiplier: Math.pow(2, 8),
        diff: '0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff',
        hash: function(){
            return function(){
...
for (var algo in algos){
    ...
    if (!algos[algo].diff)
        algos[algo].diff = diff1;
    else
    {
        algos[algo].diff = bignum(algos[algo].diff, 16);
        if (algos[algo].multiplier)
            algos[algo].diff = algos[algo].diff.mul(Math.pow(2, 32) / algos[algo].multiplier);
    }
