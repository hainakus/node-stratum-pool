...
var JobManager = module.exports = function JobManager(options){
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
      ...
      //  console.log(job.target.ge(headerBigNum))
        ...
        var jobtarget =  bignum(job.rpcData.target, 16)
        ...
        console.log('header', parseFloat((diff1 / jobTarget.toNumber()).toFixed(9)) >= shareDiff)
          console.log('job', parseFloat((diff1 / jobTarget.toNumber()).toFixed(9)) >= shareDiff)
        if ( parseFloat((diff1 / jobTarget.toNumber()).toFixed(9)) >= shareDiff ){
