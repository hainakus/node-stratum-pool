...
var JobManager = module.exports = function JobManager(options){
    ...
    var shareMultiplier = 1000000000;
    ...
    this.processShare = function(jobId, previousDifficulty, difficulty, extraNonce1, extraNonce2, nTime, nonce, ipAddress, port, workerName){
        ...
        console.log((headerBigNum.toNumber() / Math.pow(1,BigInt(headerBigNum.toNumber()).toString().length)))
        var shareDiff =  job.difficulty / (headerBigNum.toNumber() / Math.pow(1,BigInt(headerBigNum.toNumber()).toString().length)) * shareMultiplier;
