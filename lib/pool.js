...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function SubmitBlock(blockHex, callback){
        ...
        var input = JSON.parse(blockHex.toString())
        ...
        rpcArgs = [];
            ...
            var data = Buffer.from(JSON.stringify(input))
    ...
    function GetBlockTemplate(callback){
            ...
            _this.daemon.cmd('getminingcandidate', [], function(results){ 
                ...
                var processedNewBlock = _this.jobManager.processTemplate(results[0].response);
                    store('miningcandidate', results);
                    callback(null, results[0].response, processedNewBlock);
